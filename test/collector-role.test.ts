...
// Pi 0.83.0 may still reach the provider after the throw is swallowed; do not
  ...
  await withHermeticHome({ prefix: "ak-collector-amb-skill-" }, async ({ agentDir, home }) => {
    ...
    try {
      await withInProcessPi({
        ...
        // late before_agent_start throws are non-normative for provider entry on Pi 0.83.0.
