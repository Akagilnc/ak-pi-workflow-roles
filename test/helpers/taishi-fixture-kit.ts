/**
 * Shared fixtures for the taishi test family (#420 整改拆分收拢).
 * Extracted verbatim from taishi-entry.test.ts / taishi-public-bundle-families.test.ts —
 * no behavior change.
 */
