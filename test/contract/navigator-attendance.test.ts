...
test("model settings are exact and typed settlement projection ignores prose and correctable errors", () => {
  ...
  assert.deepEqual(publicNavigatorSettlement("secretariat", null, { toolName: "ak_secretariat_output", isError: false, details: { secretariatStatus: "sealed" } }), { kind: "accepted", role: "secretariat", phase: null, status: "sealed" });
