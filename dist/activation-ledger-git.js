...
export function isConfirmedNonRepositoryStderr(stderr) {
...
export class ActivationGitRepositoryRequiredError extends Error {
    ...
    constructor(detail, options) {
        super(`Workflow role activation requires a git repository cwd (git rev-parse --git-common-dir failed): ${detail || "unknown git error"}`, options?.cause === undefined ? undefined : { cause: options.cause });
 ...
 */
export function resolveBookKeyFromGit(cwd) {
    let commonDir;
    try {
