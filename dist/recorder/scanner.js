...
const RULES = [
    ...
    },
    {
        ...
        pattern: /\b(?:ghp|gho|ghu|ghs|ghr|github_pat|npm|sk|xox[baprs]|glpat|sk-proj|sk-ant)[_-][A-Za-z0-9\-_]{8,}\b/gi,
    },
    {
        id: "google-api-key",
    ...
    {
        id: "token-assignment",
        pattern: /\b(?:api[_-]?key|token|secret|password|passwd|access[_-]?key)\b\s*[:=]\s*['"]?[^'"\s]+/gi,
    },
];
