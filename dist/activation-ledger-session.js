...
export function childSessionManager(parent, cwd, childDirectory) { return parent?.getSessionFile() === undefined ? SessionManager.inMemory(cwd) : SessionManager.create(cwd, join(parent.getSessionDir(), childDirectory)); }
/**
