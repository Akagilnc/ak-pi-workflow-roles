...
import { ensureRealDirectoryTree, errnoCode, errorText, } from "./activation-ledger-topology.js";
/**
...
export function durableSessionPointer(sessionManager, options) {
    ...
    if (!isAbsolute(file)) {
        throw new Error(`Workflow role activation requires an absolute durable session file path; got relative path: ${file}`);
    }
