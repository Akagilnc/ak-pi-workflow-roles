...
#470 御批二：法典为一部通用法（无角色分章、无退役旧词）；取证授权写通用条（一切取证席位）；交付面仅三审计席开庭材料装法典；大理寺主会话 roster 不动，其 Soul 授权句原地保留。四份受影响 Soul 不因立法典而删改。

有限覆盖本 ADR 将「通用裁决法」置于 Soul 的表述——仅就审刑院通用取证法源：该等法文入包内 `souls/audit-law.md`，三审计席开庭装入；与各 Soul 现有同义句并行不冲突。宿主 overlay 原则与其它角色分层其余仍有效。不得无证扩成全角色法典重构。
