...
有限覆盖本 ADR 将「通用裁决法」置于 Soul 的表述——仅就审刑院执法准绳与判官可逆取证授权：该等法文迁入包内 `souls/audit-law.md`，三席 auditor 与判官主会话同读；Soul 只留身份与不可约原则。宿主 overlay 原则与其它角色分层其余仍有效。不得无证扩成全角色法典重构。
