...
> **Supersession (accepted ADR 0010, 陛下 2026-07-28):** the earlier “供大理寺核查” consumer wording is superseded. Commit SHA evidence is advisory for the **caller**; Judge authorship of the repair packet and mandatory next-hop to Judge are not package requirements. The rest of this ADR remains `accepted`, subject to ADR 0010's explicit supersession.
