/**
 * Single true source for the Analyst projectRoot→bookKey rule (#399 / ADR 0048).
...
export function resolveAnalystBookKey(projectRoot: string): string {
  ...
  // #413 r2 U5 boundary at the Analyst seam: only git's own confirmed
 ...
 */
export function isSyntheticAnalystBookKey(bookKey: string): boolean {
