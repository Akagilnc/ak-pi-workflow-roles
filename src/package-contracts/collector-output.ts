...
/** Generated tool-call args (legs only) — not a terminal accepted receipt. */
...
function validateAttempt(
  ...
  const out: CollectorRequestAttempt = {
    ...
    status: value.status as CollectorRequestAttempt["status"],
  };
...
export function validateAcceptedCollectorReceipt(
  ...
  if (
    typeof value.finalObservationTime !== "string" ||
