...
// #836 r13 class 1: pattern was a real provider-enforced shape rejection on
// the role's own output — delete it; minLength stays as declared guidance
// (same fix as fixer-output.ts's nonblankTransportString).
