/**
 * Public Gleaner-Left Role run: admit (instruction may be empty) → shared
 * post-admission coordinator → settle Terminal result (#502 / ADR 0067).
...
export function buildGleanerLeftTurnRequest(
  ...
  return projectRoleTurnRequest(
    admitted,
    {
      activation: { role: "gleaner-left" as const },
    },
    options,
  );
}
