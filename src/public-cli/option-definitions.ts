...
const ROLE_COMMAND_HELP = {
  ...
  notary: {
    ...
    examples: [
      ...
      "ak-role notary --source-run 01a034f1-75bf-71a6-bcf5-d1299145b1a5@countersign",
    ],
  },
  analyst: {
    command: "analyst",
...
const SUPPORT_COMMAND_HELP = {
  ...
  config: {
    ...
    usage: [
      ...
      "ak-role config set-engine <seat> <name> [model]",
      "ak-role config unset-engine <seat>",
      "ak-role config set-engine-model <seat> <model>",
      "ak-role config unset-engine-model <seat>",
