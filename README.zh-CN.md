...
| **符宝郎** | notary | **首责唯一：核实实际授权出处**（防乱编乱扩）；引语真伪与票面对齐为手段。受审物是大理寺拟判等文书；可被门下省派发，也可 `ak-role notary` 单独调。 |
